...
// //   )
// // }
// // app/dashboard/customers/CustomersListClient.jsx
// "use client"
...
//   // إذا أردنا إعادة الجلب ديناميكياً:
//   useEffect(() => {
...
import { authOptions } from "@/lib/authOptions" // تأكد أن عندك هذا الملف
import CustomersListClient from "./_components/CustomersListClient";
import { getData } from "@/lib/getData"
...
export default async function CustomersListPage() {
  ...
  // جلب بيانات العملاء المرتبطة بالـ vendorId
   customers = await getData(`customerStores?storeId=${storeId}`);
      
    }

  }

  console.log('cccccc', customers)
  // تمرير البيانات إلى مكون الـ Client
  return <CustomersListClient rawData={customers} />;
}