    ...
    <div className="pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <h2 className="text-2xl font-bold text-indigo-700 dark:text-indigo-400 mb-6">معلومات الاتصال</h2>

            <div className="space-y-6">
              <div className="flex items-start">
                <MapPin className="h-6 w-6 text-indigo-600 ml-4 mt-1" />
                <div>
              ...
              <div className="flex items-start">
                <Clock className="h-6 w-6 text-indigo-600 ml-4 mt-1" />
                <div>
          ...
          <motion.div
            ...
            className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"
          >
            <h2 className="text-2xl font-bold text-indigo-700 dark:text-indigo-400 mb-6">أرسل لنا رسالة</h2>
