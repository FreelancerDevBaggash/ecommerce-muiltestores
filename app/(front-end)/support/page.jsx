...
export default function SupportPage() {
  ...
  return (
    <div ref={ref} className="pt-20 pb-16">
      ...
      >
        <motion.div variants={itemVariants} className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            مركز <span className="text-indigo-600 dark:text-indigo-400">الدعم</span>
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto mb-8">
      ...
      <motion.div
        ...
        animate={isInView ? "visible" : "hidden"}
        variants={containerVariants}
        className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16"
      >
      ...
      <motion.div
        ...
        animate={isInView ? "visible" : "hidden"}
        variants={containerVariants}
        className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-gray-50 dark:bg-slate-900/50 rounded-2xl mb-16"
      >
        <motion.h2 variants={itemVariants} className="text-2xl font-bold text-gray-900 dark:text-white mb-6">
          المشاكل الشائعة
        </motion.h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      >
        <motion.h2 variants={itemVariants} className="text-3xl font-bold text-gray-900 dark:text-white mb-8 text-center">
          تواصل معنا
        </motion.h2>
        ...
        <Tabs defaultValue="chat" className="w-full">
          ...
          <TabsContent value="email">
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  يمكنك إرسال استفسارك إلى <span className="text-indigo-600 dark:text-indigo-400">support@atjar.com</span>
                </p>
                <Button className="w-full bg-indigo-600 hover:bg-indigo-700 text-white">إرسال بريد إلكتروني</Button>
              </CardContent>
              <CardFooter className="text-sm text-gray-500 dark:text-gray-400">
          ...
          <TabsContent value="phone">
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  يمكنك الاتصال بنا على الرقم <span className="text-indigo-600 dark:text-indigo-400">+966 12 345 6789</span>
                </p>
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  ساعات العمل: الأحد إلى الخميس، من الساعة 9 صباحاً حتى 5 مساءً.
                </p>
