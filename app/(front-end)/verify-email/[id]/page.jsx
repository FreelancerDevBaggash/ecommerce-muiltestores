...
import { getData } from '@/lib/getData'
import VerifyEmail from "../../../../components/frontend/front-end_home/VerifyEmail"
export default async function OTPVerificationPage({params: { id }}) {
  const vendors =await getData(`vendors/${ id }`)
  console.log('vendorsvendorsvendorsvendorsvendors',vendors.verificationToken)


  return (
<div className="">
  <VerifyEmail verificationToken={vendors.verificationToken } vendorId={vendors.id} />
</div>
  );
}
