...
import { getData } from '@/lib/getData'
import VerifyPhone from "../../../../components/frontend/front-end_home/VerifyPhone"
export default async function OTPVerificationPage({params: { id }}) {
  const vendors =await getData(`vendors/${ id }`)
  console.log('vendorsvendorsvendorsvendorsvendors',vendors.verificationCode)


  return (
<div className="">
  <VerifyPhone verificationCode={vendors.verificationCode } vendorId={vendors.id} />
</div>
  );
}
