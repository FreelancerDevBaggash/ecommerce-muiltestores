...
import RegisterCustomerFromVendorStore from "../../../components/frontend/front-end_home/RegisterCustomerFromVendorStore.jsx";
...
export default async function Register({ params:{slugDomain}}) {
   const store = await getData(`/stores/store/${slugDomain}`);
    console.log('Fetched store data slugDomain:', store);
    const storeId = store.id ;
  return (
    <section dir='rtl' className="bg-gray-50 items-center dark:bg-gray-900">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start mb-12 lg:mb-0">
          ...
          <div className="w-full  bg-white items-center rounded-lg shadow-xl dark:bg-gray-800">
            <div className="p-8 space-y-6">
              ...
              <RegisterCustomerFromVendorStore  storeId={storeId} slugDomain={slugDomain}/>
            </div>
          </div>
        </div>
