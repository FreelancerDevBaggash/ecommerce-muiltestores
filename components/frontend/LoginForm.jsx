    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 ">
      ...
      <div className="flex gap-4 items-center">
        ...
        {loading ? (
          <button
            disabled
            type="button"
            className="w-full text-white bg-indigo-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center"
          >
            <svg
              aria-hidden="true"
              role="status"
      ...
      <p className="text-sm font-light text-gray-500 dark:text-gray-400">
        ...
        <Link
          ...
          className="font-medium text-indigo-600 hover:underline dark:text-blue-500"
        >
          Sign Up
        </Link>
      </p>
