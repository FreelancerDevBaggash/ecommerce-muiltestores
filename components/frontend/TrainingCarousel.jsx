    ...
    <p className='px-4 line-clamp-3 text-slate-800
     dark:text-slate-300 mb-2'>
      {training.description}
         ...
         <Link className="bg-lime-600 hover:bg-lime-700 
           duration-300 transition-all text-slate-50 rounded-md
           px-4 py-2" href="#">Read more</Link>  
