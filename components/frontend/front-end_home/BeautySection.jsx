...
export default function BeautySection() {
  ...
  const categoryContent = {
    المطاعم: {
      title: "ضاعف حصتك في سوق الخدمات الغذائية",
      description:
        "سواءً كنت تبيع مأكولات ومشروبات طازجة أو معلَّبة ومجمَّدة، حلول اتجر تسهِّل لك استقبال وشحن الطلبات حتى تصل لعميلك بأفضل جودة.",
      features: [
    ...
    "المطاعم والكافيهات": {
      title: "حلول متكاملة للمطاعم والكافيهات",
      description:
        "أطلق متجرك الإلكتروني للمطاعم والكافيهات مع حلول اتجر المتخصصة التي تمكنك من عرض قائمة الطعام وإدارة الطلبات وتوصيلها بكفاءة.",
      features: [
        "قوائم طعام تفاعلية سهلة التحديث",
        "نظام حجز طاولات وإدارة الطلبات",
        "خدمات توصيل متكاملة مع تتبع مباشر",
    ...
    "العناية والتجميل": {
      title: "حلول متكاملة لبيع منتجات العناية والتجميل",
      description:
        "وسع نطاق عملك في مجال العناية والتجميل مع حلول  المخصصة لتلبية احتياجات عملائك وعرض منتجاتك بأفضل طريقة.",
      features: [
    ...
    المجوهرات: {
      title: "ارتقِ بتجارة المجوهرات الخاصة بك",
      description:
        "قدم مجوهراتك بطريقة فاخرة مع حلول اتجر المصممة خصيصًا لتجار المجوهرات والإكسسوارات الراقية.",
      features: [
    ...
    الإلكترونيات: {
      title: "حلول متكاملة لبيع الإلكترونيات",
      description:
        "توسع في تجارة الأجهزة الإلكترونية والمنزلية والكهربائية عبر حلول اتجر المخصصة لتلائم طبيعة منتجاتك واحتياجات عملائك.",
      features: [
    ...
    "الصحة واللياقة": {
      title: "عزز مبيعاتك في قطاع الصحة واللياقة",
      description:
        "قدم منتجات الصحة واللياقة البدنية بطريقة احترافية مع حلول اتجر المتكاملة لتحسين تجربة العملاء وزيادة المبيعات.",
      features: [
        "عرض تفاصيل المكونات والفوائد بوضوح",
        "نظام اشتراكات مرن للمنتجات المتكررة",
        "محتوى تثقيفي متكامل مع المنتجات",
    ...
    "المنتجات الرقمية": {
      title: "أطلق متجرك للمنتجات الرقمية",
      description:
        "بيع الكتب الإلكترونية والدورات التدريبية والبرامج وغيرها من المنتجات الرقمية بسهولة مع حلول اتجر المتخصصة.",
      features: [
    ...
    "عبايات وأزياء": {
      title: "ارتقِ بمتجر الأزياء الخاص بك",
      description:
        "قدم تشكيلات الأزياء والعبايات بطريقة عصرية مع حلول اتجر المصممة خصيصًا لتجار الملابس والأزياء.",
      features: [
    ...
    "المواقع الشخصية": {
      title: "أنشئ موقعك الشخصي الاحترافي",
      description:
        "أطلق موقعك الشخصي أو سيرتك الذاتية أو معرض أعمالك بتصميم احترافي مع حلول اتجر المخصصة للمواقع الشخصية.",
      features: [
