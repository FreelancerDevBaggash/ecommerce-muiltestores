...
export default function AutoPlay({ products, customization = {} }) {
  ...
  const settings = {
    ...
    slidesToShow: 4, // يعرض 4 منتجات بشكل افتراضي
    slidesToScroll: 1, // تمرير منتج واحد عند التحرك
    autoplay: true, // تشغيل السلايدر تلقائيًا
    speed: 1000, // سرعة التحرك
    autoplaySpeed: 3000, // سرعة التبديل بين الشرائح
    cssEase: "ease", // التأثير على الحركة
    responsive: [
      {
        breakpoint: 1280, // الشاشات التي تزيد عن 1280px (أجهزة سطح المكتب الكبيرة)
        settings: {
          slidesToShow: 4, // يعرض 4 منتجات
          slidesToScroll: 1, // تمرير منتج واحد عند التحرك
        },
      },
      {
        breakpoint: 1024, // الشاشات التي تزيد عن 1024px (أجهزة سطح المكتب المتوسطة)
        settings: {
          slidesToShow: 3, // يعرض 3 منتجات
          slidesToScroll: 1, // تمرير منتج واحد عند التحرك
        },
      },
      {
        breakpoint: 768, // الشاشات التي تزيد عن 768px (الأجهزة اللوحية)
        settings: {
          slidesToShow: 2, // يعرض 2 منتجات
          slidesToScroll: 1, // تمرير منتج واحد عند التحرك
        },
      },
      {
        breakpoint: 480, // الشاشات التي تزيد عن 480px (الأجهزة المحمولة)
        settings: {
          slidesToShow: 1, // يعرض منتج واحد فقط
          slidesToScroll: 1, // تمرير منتج واحد عند التحرك
        },
      },
    ],
