...
//       >
//         <ShoppingBag className="text-lime-700 dark:text-lime-500" />
...
//          text-white bg-transparent rounded-lg "
//         >
//             <ShoppingBag className="text-lime-700 dark:text-lime-500" style={{ color: backgroundColor }}/>
//             <span className="sr-only">Cart</span>
//             <div className="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-red-500  rounded-full -top-0 end-6 dark:border-gray-900">
//                 {cartItems.length}
//             </div>
...
export default function CartCount({ slugDomain, customization = {} }) {
 const primaryColor = customization?.primaryColor || '#4CAF50'; // اللون الأساسي
    ...
    return (
        ...
        >
            <ShoppingBag className="text-lime-700 dark:text-lime-500" style={{ color: primaryColor }} />
            <span className="sr-only">Cart</span>
            {cartCount > 0 && (
                <div className="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-red-500 rounded-full -top-0 end-6 dark:border-gray-900">
                    {cartCount}
