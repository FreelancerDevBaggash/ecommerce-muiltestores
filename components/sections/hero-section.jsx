...
// import heroLottieData from "@/public/animations/hero-animation.json"
...
//           {/* Text Content */}
//           <motion.div style={{ opacity, scale }} className="text-center lg:text-right">
//             <TextReveal>
//               <h1 className="hero-title text-5xl sm:text-6xl lg:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-l from-indigo-600 to-indigo-400 dark:from-indigo-400 dark:to-indigo-200">
...
//                   >
//                     <Image
//                       src={`/public/placeholder.svg?height=40&width=40&text=${i}`}
//                       alt={`User ${i}`}
//                       width={40}
//                       height={40}
//                     />
...
//               className="relative"
//               style={{
//                 transform: `perspective(1000px) rotateY(${(mouseX - window.innerWidth / 2) / 50}deg) rotateX(${(window.innerHeight / 2 - mouseY) / 50}deg)`
//               }}
...
//                 </div>
//                 <div className="p-4">
//                   <div ref={lottieRef} className="w-full h-[300px]"></div>
//                 </div>
//               </div>
//             </motion.div>
...
export default function HeroSection() {
  ...
  // compute rotate angles safely
  const rotateY = (mouseX - dims.width / 2) / 50
  const rotateX = (dims.height / 2 - mouseY) / 50
